const MicrophoneSlashIcon = ({ size = 24 }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512" width={size} height={size} role="img" aria-label="microphone slash icon">
